...
var stomp_state_1 = require("./stomp-state");
/**
...
var StompRService = /** @class */ (function () {
    ...
    function StompRService() {
        ...
        this.on_connect = function (frame) {
            ...
            _this._changeState(stomp_state_1.StompState.CONNECTED);
        };
        this.state = new rxjs_1.BehaviorSubject(stomp_state_1.StompState.CLOSED);
        this.connectObservable = this.state.pipe(operators_1.filter(function (currentState) {
            return currentState === stomp_state_1.StompState.CONNECTED;
        }));
        ...
        this.serverHeadersObservable = this._serverHeadersBehaviourSubject.pipe(operators_1.filter(function (headers) {
            return headers !== null;
        }));
        this.stompError$ = new rxjs_1.Subject();
    }
    ...
    StompRService.prototype.initStompClient = function () {
        ...
        if (typeof (this._config.url) === 'string') {
            this.client = stompjs_1.Stomp.client(this._config.url);
        }
        else {
            this.client = stompjs_1.Stomp.over(this._config.url);
        }
    ...
    StompRService.prototype.initAndConnect = function () {
        ...
        this.client.configure({
            ...
            onWebSocketClose: function () {
                _this._changeState(stomp_state_1.StompState.CLOSED);
            },
        ...
        this._changeState(stomp_state_1.StompState.TRYING);
    };
    /**
    ...
    StompRService.prototype.disconnect = function () {
        ...
        if (this.client) {
            ...
            if (!this.client.connected) {
                // Nothing to do
                this._changeState(stomp_state_1.StompState.CLOSED);
                return;
            }
            // Notify observers that we are disconnecting!
            this._changeState(stomp_state_1.StompState.DISCONNECTING);
        }
    };
    /**
    ...
    StompRService.prototype.connected = function () {
        return this.state.getValue() === stomp_state_1.StompState.CONNECTED;
    };
    /**
    ...
    StompRService.prototype.subscribe = function (queueName, headers) {
        ...
        var coldObservable = rxjs_1.Observable.create(function (messages) {
            ...
            return function () {
                ...
                if (_this.state.getValue() === stomp_state_1.StompState.CONNECTED) {
    ...
    StompRService.prototype.setupOnReceive = function () {
        var _this = this;
        this.defaultMessagesObservable = new rxjs_1.Subject();
    ...
    StompRService.prototype.setupReceipts = function () {
        var _this = this;
        this.receiptsObservable = new rxjs_1.Subject();
